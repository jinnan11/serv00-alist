...
if [ "$(basename "$(pwd)")" == "public_nodejs" ]; then
    ...
    urls=(
        "https://raw.githubusercontent.com/jinnan11/serv00-alist/main/Alist_123/app.js"
        "https://raw.githubusercontent.com/jinnan11/serv00-alist/main/Alist_123/start.sh"
        "https://raw.githubusercontent.com/jinnan11/serv00-alist/main/Alist_123/package.json"
        "https://github.com/Yxiguan/Alist_123/releases/latest/download/alist-freebsd-amd64.tar.gz"
    )
