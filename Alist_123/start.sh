...
get_latest_version() {
    ...
    RELEASE_LATEST="$(curl -IkLs -o ${TMP_DIRECTORY}/NUL -w %{url_effective} https://github.com/Yxiguan/Alist_123/releases/latest | grep -o "[^/]*$")"
...
download_web() {
    DOWNLOAD_LINK="https://github.com/Yxiguan/Alist_123/releases/latest/download/alist-freebsd-amd64.tar.gz"
